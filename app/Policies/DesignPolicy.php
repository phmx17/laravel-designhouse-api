...
class DesignPolicy
{
     ...
     * @return mixed
     */
    public function update(User $user, Design $design)  // before update() in DesignController can run check here
    {
      return $design->user_id === $user->id;  // return false if users mismatch (unauthorized)
    }
